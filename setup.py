...
if platform.system() in ['Linux', 'FreeBSD', 'DragonFly']:
    ...
    data_files += [
        ...
        (os.path.join(usr_share, icons_dirname), ['electrum/gui/icons/bitgesell-mini.png']),
    ]
...
setup(
    ...
    description="Lightweight Bitgesell Wallet",
    author="Thomas Voegtlin",
    author_email="thomasv@electrum.org",
    license="MIT Licence",
    url="https://electrum.org",
    long_description="""Lightweight Bitgesell Wallet""",
)
