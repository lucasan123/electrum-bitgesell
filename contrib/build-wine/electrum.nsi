...
;Variables
  ...
  !define PRODUCT_NAME "Bitgesell light wallet"
...
;Interface Settings
  ...
  !define MUI_ICON "c:\electrum\electrum\gui\icons\logo.ico"
...
Section
  ...
  File "c:\electrum\electrum\gui\icons\logo.ico"
  ...
  ;Links bitgesell: URI's to Electrum
  WriteRegStr HKCU "Software\Classes\bitgesell" "" "URL:bitgesell Protocol"
  WriteRegStr HKCU "Software\Classes\bitgesell" "URL Protocol" ""
  WriteRegStr HKCU "Software\Classes\bitgesell" "DefaultIcon" "$\"$INSTDIR\logo.ico, 0$\""
  WriteRegStr HKCU "Software\Classes\bitgesell\shell\open\command" "" "$\"$INSTDIR\electrum-${PRODUCT_VERSION}.exe$\" $\"%1$\""
  ...
  WriteRegStr HKCU "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\logo.ico"
...
Section "Uninstall"
  ...
  DeleteRegKey HKCU "Software\Classes\bitgesell"
