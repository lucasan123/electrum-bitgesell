...
from electrum.bitgesell import int_to_hex, var_int, is_segwit_script_type
...
try:
    ...
    from btchip.bitgesellTransaction import bitgesellTransaction
    from btchip.btchipFirmwareWizard import checkFirmware, updateFirmware
    from btchip.btchipException import BGLhipException
    BGLHIP = True
    BGLHIP_DEBUG = False
except ImportError:
    BGLHIP = False
...
MSG_NEEDS_FW_UPDATE_SEGWIT = _('Firmware version (or "Bitgesell" app) too old for Segwit support. Please update at') + \
                      ' https://www.ledgerwallet.com'
        ...
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00 or e.sw == 0x6700):
                    raise UserFacingException(_("Device not in Bitgesell mode")) from e
                raise e
        ...
        try:
            ...
            for utxo in inputs:
                ...
                if segwitTransaction:
                    ...
                    txtmp = bitgesellTransaction(bfh(utxo[0]))
...
class LedgerPlugin(HW_PluginBase):
    ...
    def get_btchip_device(self, device):
        ...
        return HIDDongleHIDAPI(dev, ledger, BGLHIP_DEBUG)
