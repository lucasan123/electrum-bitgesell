...
from electrum import storage, bitgesell, keystore, bip32, wallet
...
class TestWalletOfflineSigning(TestCaseForTestnet):
    ...
    def test_sending_offline_hd_multisig_online_addr_p2wsh_p2sh(self, mock_save_db):
        ...
        #               this switch is needed to interop with bitgesell core... https://github.com/bitgesell/bitgesell/blob/fba574c908bb61eff1a0e83c935f3526ba9035f2/src/psbt.cpp#L163
