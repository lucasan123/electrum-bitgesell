...
from electrum.bitgesell import (public_key_to_p2pkh, address_from_private_key,
                              ...
                              opcodes, base_encode, base_decode, BitgesellException)
...
class Test_bitgesell(ElectrumTestCase):
    ...
    def test_push_script(self):
        # https://github.com/bitgesell/bips/blob/master/bip-0062.mediawiki#push-operators
    ...
    def test_add_number_to_script(self):
        # https://github.com/bitgesell/bips/blob/master/bip-0062.mediawiki#numbers
...
class Test_bitgesell_testnet(TestCaseForTestnet):
...
class Test_xprv_xpub(ElectrumTestCase):
    ...
    xprv_xpub = (
        # Taken from test vectors in https://en.bitgesell.it/wiki/BIP_0032_TestVectors
    ...
    def test_bip32(self):
        # see https://en.bitgesell.it/wiki/BIP_0032_TestVectors
...
class Test_keyImport(ElectrumTestCase):
    ...
    def test_segwit_uncompressed_pubkey(self):
        with self.assertRaises(BitgesellException):
