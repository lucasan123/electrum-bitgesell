...
from electrum.electrum import (public_key_to_p2pkh, address_from_private_key,
...
class Test_bitgesell(ElectrumTestCase):
    ...
    def test_push_script(self):
        # https://github.com/electrum/bips/blob/master/bip-0062.mediawiki#push-operators
    ...
    def test_add_number_to_script(self):
        # https://github.com/electrum/bips/blob/master/bip-0062.mediawiki#numbers
...
class Test_xprv_xpub(ElectrumTestCase):
    ...
    xprv_xpub = (
        # Taken from test vectors in https://en.electrum.it/wiki/BIP_0032_TestVectors
    ...
    def test_bip32(self):
        # see https://en.electrum.it/wiki/BIP_0032_TestVectors
