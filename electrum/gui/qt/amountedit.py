...
class AmountEdit(FreezableLineEdit):
    ...
    def __init__(self, base_unit, is_int=False, parent=None):
        ...
        # This seems sufficient for hundred-BGL amounts with 8 decimals
...
class BGLAmountEdit(AmountEdit):
...
class FeerateEdit(BGLAmountEdit):
    ...
    def get_amount(self):
        sat_per_byte_amount = BGLAmountEdit.get_amount(self)
