...
from .bitgesell import hash160_to_b58_address, b58_address_to_hash160
...
def shorten_amount(amount):
    """ Given an amount in bitgesell, shorten it
    """
...
def encode_fallback(fallback, currency):
    ...
    """
    if currency in [constants.BitgesellMainnet.SEGWIT_HRP, constants.BitgesellTestnet.SEGWIT_HRP]:
...
base58_prefix_map = {
    constants.BitgesellMainnet.SEGWIT_HRP : (constants.BitgesellMainnet.ADDRTYPE_P2PKH, constants.BitgesellMainnet.ADDRTYPE_P2SH),
    constants.BitgesellTestnet.SEGWIT_HRP : (constants.BitgesellTestnet.ADDRTYPE_P2PKH, constants.BitgesellTestnet.ADDRTYPE_P2SH)
}
...
class LnAddr(object):
    def __init__(self, *, paymenthash: bytes = None, amount=None, currency=None, tags=None, date=None,
        ...
        self.amount = amount  # in bitgesells
